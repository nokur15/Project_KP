...
if __name__ == '__main__':
    ...
    ap.add_argument("-t", "--output", type=str, help="path to optional output video file")
    ...
    t = threading.Thread(target=people_counter, args=(args["prototxt"],args["model"],args["output"], args["confidence"], args["skip_frames"]))
    t.daemon = True
    t.start()
